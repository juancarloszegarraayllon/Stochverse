...
- **C2c — still planned**: parameterized sub-markets (Spread / Total / Over/Under — needs title-parsing to extract thresholds so different sources resolve to the same canonical params), per_leg ticker handling (tennis sets, esports maps), request-time wiring of v2 to the registry. Status: _planned_.
